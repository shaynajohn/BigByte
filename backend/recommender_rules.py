...
CUISINE_SYNONYMS: dict[str, list[str]] = {
    "Pizza": ["Pizza"],
    "Burgers": ["Burgers", "American (Traditional)"],
    ...
    "Indian": ["Indian", "Pakistani", "Bangladeshi", "South Indian", "Himalayan/Nepalese", "Curry", "Dosa"],
    "Korean": ["Korean"],
    "Mediterranean": ["Mediterranean", "Middle Eastern", "Turkish", "Lebanese", "Falafel", "Kebab", "Arabic"],
    "Greek": ["Greek"],
    "Caribbean": ["Caribbean", "Cuban", "Puerto Rican", "Dominican", "Trinidadian", "Haitian", "Jamaican"],
