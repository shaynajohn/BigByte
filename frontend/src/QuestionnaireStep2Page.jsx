...
export function QuestionnaireStep2Page({ groupId, groupExists, actorId, onBack, onNext }) {
  ...
  const [dealbreaker, setDealbreaker] = useState(initial?.cuisine_dealbreaker_level ?? 3)
    ...
    <div className="q-stars-page">
      ...
      <div className="q-stars__main">
        ...
        <h1 className="q-stars__title">
          What types of food are you in the mood for? (Select all that apply)
        </h1>
        ...
        <div className="q-cuisine__tags" role="group" aria-label="Cuisine types">
