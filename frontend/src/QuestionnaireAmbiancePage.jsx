 ...
 */
export function QuestionnaireAmbiancePage({
  groupId,
  groupExists,
  actorId,
  onBack,
  ...
  const initial = useMemo(
    () => loadAmbianceDraft(groupId, actorId),
    [groupId, actorId],
  );
  const [selected, setSelected] = useState(
    () => new Set(initial?.ambiance_types_selected ?? []),
  );
  const [dealbreaker, setDealbreaker] = useState(
    initial?.ambiance_dealbreaker_level ?? 3,
  );
  ...
  function handleNext() {
    ...
    saveAmbianceDraft(
      groupId,
      { ambiance_types_selected, ambiance_dealbreaker_level },
      actorId,
    );
  ...
  const asideLeft = (
    <div className="q-stars__aside q-stars__aside--left" aria-hidden>
      <div className="q-stars__aside-crop q-stars__aside-crop--ambiance-left">
        <img
          src="/questionnaire-ambiance-left.png"
          alt=""
          width={900}
          height={1200}
          decoding="async"
  ...
  const asideRight = (
    <div className="q-stars__aside q-stars__aside--right" aria-hidden>
      <div className="q-stars__aside-crop q-stars__aside-crop--ambiance-right">
        <img
          src="/questionnaire-ambiance-right.png"
          alt=""
          width={900}
          height={1200}
          decoding="async"
  ...
  return (
    <div className="q-stars-page">
      ...
      <div className="q-stars__main">
        ...
        <p className="q-flow__eyebrow">Step 5 of 5</p>
        <h1 className="q-stars__title">What&apos;s the vibe?</h1>
