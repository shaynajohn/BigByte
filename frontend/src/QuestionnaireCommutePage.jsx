...
export function QuestionnaireCommutePage({
  ...
  function useCurrentLocation() {
    ...
    if (!navigator.geolocation) {
      setLocalError(
        "Location sharing is not available in this browser. Type an approximate location instead.",
      );
      return;
    }
    setLocating(true);
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => {
        ...
        setStatus("");
        setLocalError(
          "Could not access your location. Type an approximate latitude and longitude instead.",
        );
      },
  ...
  function handleNext() {
    ...
    if (lat == null || lng == null) {
      setLocalError(
        "Use your current location or enter valid latitude and longitude values.",
      );
      return;
    }
    if (!isSupportedOrigin(lat, lng)) {
      setLocalError(
        "Use a Bay Area location so commute times make sense for San Francisco restaurants.",
      );
      return;
    }
    const draft = {
    ...
    <div className="q-stars-page">
      ...
      <div className="q-stars__main">
        ...
        <div className="q-commute">
          ...
          <div
            className="q-cuisine__tags q-commute__modes"
            role="group"
            aria-label="Preferred commute mode"
          >
          ...
          <div className="q-stars__dealbreaker q-commute__minutes">
            <p className="q-stars__dealbreaker-heading">
